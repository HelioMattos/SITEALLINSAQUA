	...
	<div class="linha">
		<section>
			...
			<div class="cad-body">
                ...
                <form method="POST" action= "salvar_ponto.php" class="cad-form" enctype="multipart/form-data">
                    ...
                    <label class="cad-label">Sobre:</label>
                    <input type="text" name="sobre" class="cad-input" required>

                    <label class="cad-label">Upload da Imagem:</label>
